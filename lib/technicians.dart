...
class _TechniciansState extends State<Technicians> {
  Future<Album> fetchAlbum() async {
    ...
    for (int i = 0; i < b['category']['Technicians']['children'].length; i++) {
      ...
      sum7[i] = ((b['category']['Technicians']['children'][i]['text']));
    }
    // for (int i = 0;
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  estBud: NumberFormat.currency(
                                                                      ...
                                                                      .format(num
                                                                          .parse(
                                                                    snapshot.data!.category['Technicians']['children']
                                                                            [
                                                                            iv1]
                                                                        [
                                                                        'estimated_budget'],
                                                                  ...
                                                                  variance: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '₹ ##,##,###.#')
                                                                      .format(num.parse((snapshot.data!.category['Technicians']['children'][iv1]
                                                                              [
                                                                              'estimated_budget'])) -
                                                                          technicianactualspent[
                                                                              iv1]),
                                                                  utilsation: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((technicianactualspent[iv1] /
                                                                              num.parse((snapshot.data!.category['Technicians']['children'][iv1]['estimated_budget'])) *
                                                                              100) /
                                                                          100),
                                                                  ...
                                                                  difference: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((totalshoot -
                                                                              (technicianactualspent[iv1] / num.parse((snapshot.data!.category['Technicians']['children'][iv1]['estimated_budget'])) * 100)) /
                                                                          100),
                                                                ),
                                                              ),
                                                            );
