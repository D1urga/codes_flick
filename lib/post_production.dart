...
class PostProduction extends StatefulWidget {
  const PostProduction({super.key});

  @override
  State<PostProduction> createState() => _PostProductionState();
}
...
//     b['category']['Common Shoot Expenses']['children'].length, (i) => 0);
...
class _PostProductionState extends State<PostProduction> {
  Future<Album> fetchAlbum() async {
    ...
    // }
    // for (int i = 0;
    //     i < b['category']['Common Shoot Expenses']['children'].length;
    //     i++) {
    //   sum4[i] = (num.parse(b['category']['Common Shoot Expenses']['children'][i]
    //       ['estimated_budget']));
    // }
    // for (int i = 0;
    ...
    for (int i = 0;
      ...
      sum7[i] = ((b['category']['Post Production']['children'][i]['text']));
    }
    ...
    // }
    // for (int j = 0;
    //     j < b['category']['Common Shoot Expenses']['children'].length;
    //     j++) {
    //   for (int i = 0; i < b['actual_spent'].length; i++) {
    //     if (b['actual_spent'][i]['category_id'] ==
    //         b['category']['Common Shoot Expenses']['children'][j]['id']) {
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  estBud: NumberFormat.currency(
                                                                      ...
                                                                      .format(num
                                                                          .parse(
                                                                    snapshot.data!.category['Post Production']['children']
                                                                            [
                                                                            iv1]
                                                                        [
                                                                        'estimated_budget'],
                                                                  ...
                                                                  actspt: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '₹ ##,##,###.#')
                                                                      .format(postproductionactualspent[
                                                                          iv1]),
                                                                  variance: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '₹ ##,##,###.#')
                                                                      .format(num.parse((snapshot.data!.category['Post Production']['children'][iv1]
                                                                              [
                                                                              'estimated_budget'])) -
                                                                          postproductionactualspent[
                                                                              iv1]),
                                                                  utilsation: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((postproductionactualspent[iv1] /
                                                                              num.parse((snapshot.data!.category['Post Production']['children'][iv1]['estimated_budget'])) *
                                                                              100) /
                                                                          100),
                                                                  ...
                                                                  difference: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((totalshoot -
                                                                              (postproductionactualspent[iv1] / num.parse((snapshot.data!.category['Post Production']['children'][iv1]['estimated_budget'])) * 100)) /
                                                                          100),
                                                                ),
                                                              ),
                                                            );
