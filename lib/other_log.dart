...
class OtherLog extends StatefulWidget {
  const OtherLog({super.key});

  @override
  State<OtherLog> createState() => _OtherLogState();
}

TextEditingController shootdate = TextEditingController();
TextEditingController slCont = TextEditingController();
TextEditingController location = TextEditingController();
TextEditingController hire = TextEditingController();
...
class _OtherLogState extends State<OtherLog> {
  @override
