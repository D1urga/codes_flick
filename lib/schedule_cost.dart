...
class ScheduleCost extends StatefulWidget {
  const ScheduleCost({super.key});

  @override
  State<ScheduleCost> createState() => _ScheduleCostState();
}
...
class _ScheduleCostState extends State<ScheduleCost> {
  Future<Album> fetchAlbum() async {
    ...
    for (int i = 0;
      ...
      sum7[i] = ((b['category']['Schedule Cost']['children'][i]['text']));
    }
    // for (int i = 0;
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  estBud: NumberFormat.currency(
                                                                      ...
                                                                      .format(num
                                                                          .parse(
                                                                    snapshot.data!.category['Schedule Cost']['children']
                                                                            [
                                                                            iv1]
                                                                        [
                                                                        'estimated_budget'],
                                                                  ...
                                                                  variance: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '₹ ##,##,###.#')
                                                                      .format(num.parse((snapshot.data!.category['Schedule Cost']['children'][iv1]
                                                                              [
                                                                              'estimated_budget'])) -
                                                                          scheduleactualspent[
                                                                              iv1]),
                                                                  utilsation: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((scheduleactualspent[iv1] /
                                                                              num.parse((snapshot.data!.category['Schedule Cost']['children'][iv1]['estimated_budget'])) *
                                                                              100) /
                                                                          100),
                                                                  ...
                                                                  difference: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((totalshoot -
                                                                              (scheduleactualspent[iv1] / num.parse((snapshot.data!.category['Schedule Cost']['children'][iv1]['estimated_budget'])) * 100)) /
                                                                          100),
                                                                ),
                                                              ),
                                                            );
