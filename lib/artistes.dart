...
class _ArtistesState extends State<Artistes> {
  Future<Album> fetchAlbum() async {
    ...
    for (int i = 0; i < b['category']['Artistes']['children'].length; i++) {
      ...
      sum7[i] = ((b['category']['Artistes']['children'][i]['text']));
    }
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  estBud: NumberFormat.currency(
                                                                      ...
                                                                      .format(num
                                                                          .parse(
                                                                    snapshot.data!.category['Artistes']['children']
                                                                            [
                                                                            iv1]
                                                                        [
                                                                        'estimated_budget'],
                                                                  ...
                                                                  variance: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '₹ ##,##,###.#')
                                                                      .format(num.parse((snapshot.data!.category['Artistes']['children'][iv1]
                                                                              [
                                                                              'estimated_budget'])) -
                                                                          artistactualspent[
                                                                              iv1]),
                                                                  utilsation: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((artistactualspent[iv1] /
                                                                              num.parse((snapshot.data!.category['Artistes']['children'][iv1]['estimated_budget'])) *
                                                                              100) /
                                                                          100),
                                                                  ...
                                                                  difference: NumberFormat.currency(
                                                                          ...
                                                                          customPattern:
                                                                              '##,##,###.#%')
                                                                      .format((totalshoot -
                                                                              (artistactualspent[iv1] / num.parse((snapshot.data!.category['Artistes']['children'][iv1]['estimated_budget'])) * 100)) /
                                                                          100),
                                                                ),
                                                              ),
                                                            );
